...
const Project = ({ project }: TProps) => {
  return (
    <div tw="flex flex-col gap-x-[5rem] justify-between w-full laptop:flex-row">
      <ImageWrapper tw="relative w-full mb-6 h-[300px] tablet:h-[400px] laptop:mb-0 laptop:h-[350px] laptop:w-[350px] laptop:min-w-[350px]">
        <Image
          src={project.cover}
          alt="cover"
          fill
